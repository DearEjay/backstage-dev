...
import { Music, Calendar, Users, FileText, BarChart3, User, Code } from 'lucide-react';
  ...
  return (
    <div className="bg-white border-r border-gray-200 w-64 p-6">
      <div className="mb-8">
        ...
        <div className="mt-2 flex items-center gap-1 text-xs bg-yellow-100 text-yellow-700 px-2 py-1 rounded">
          <Code size={12} />
          DEV MODE
        </div>
      </div>
...
const Navigation = () => {
  ...
  return (
    <div className="bg-white border-r border-gray-200 w-64 p-6">
      ...
      {// Coming Soon Section }
      <div className="mt-8 pt-8 border-t border-gray-200">
        <h3 className="text-xs uppercase text-gray-400 font-semibold mb-3">Coming Soon</h3>
        <div className="space-y-2">
          <div className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-gray-400 cursor-not-allowed">
            <span className="text-sm">📅 Global Calendar</span>
          </div>
          <div className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-gray-400 cursor-not-allowed">
            <span className="text-sm">👥 Team Dashboard</span>
          </div>
          <div className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-gray-400 cursor-not-allowed">
            <span className="text-sm">📋 Contract Library</span>
          </div>
          <div className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-gray-400 cursor-not-allowed">
